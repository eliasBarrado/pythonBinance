...
def monitor_closing_position_order(closing_position_order):
    ...
    while(position_information['markPrice'] - float(closing_position_order['price']) < 2):
        ...
        while(position_information['unRealizedProfit'] < 0.01):
            ...
            if(abs(position_information['positionAmt'] - MAX_POSITION_SIZE) > position_information['positionAmt']*0.5  ):
                ...
                if(position_information['liquidationPrice'] - position_information['markPrice'] < 40):
                    ...
                    avoid_liquidation_order = create_order(position_information['liquidationPrice'] - 2, 'SELL', position_information['positionAmt']*0.5 )
